 ...
 * порциями по limit)
 */
croc.Class.define('croc.data.chain.ArrayStreamingProxy', {
    extend: croc.data.chain.Array,
    ...
    construct: function(options) {
        ...
        croc.data.chain.ArrayStreamingProxy.superclass.__construct__.apply(this, arguments);
    ...
    members: {
        ...
        getItem: function(index) {
            ...
            return croc.data.chain.ArrayStreamingProxy.superclass.getItem.apply(this, arguments);
        },
